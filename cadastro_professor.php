...
<body id="body-login">
    <form action="actions/action_cadastra_professor.php" method="post" class="container-fluid">
        <div class="container w-50 border border-3 rounded p-4 mt-3 shadow " style="background-color: #E2E3E5;">
            <h2 class="text-center mb-4 fw-bolder">Cadastro de Professor</h2>
            <div class="mb-3">
            ...
            <div class="mb-3 d-flex align-items-center ">
                <div class="container">
                    ...
                    <input type="date" id="data_nascimento_input" name="data_nascimento_input" class="form-control" max="<?= $dataMinima ?>" required>
                </div>
                <div class="container">
