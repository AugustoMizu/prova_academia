    ...
    <main class="container-fluid">
        <div class="config-container container w-50 border border-3 rounded p-5 shadow position-absolute top-50 start-50 translate-middle bg-secondary-subtle">
            ...
            <div class="config-options text-black">
                <div class="option">
                    <a href="editar_admin.php"><label for="perfil">Editar Dados Pessoais</label> </a>
                </div>
                <div class="option">
                    ...
                    <div class="submenu border border-3 rounded p-4 shadow">
                        ...
                        <ul>
                            <a href="tabela_pagamento.php" class="text-black link-underline link-underline-opacity-0">
                                <li>Visualizar/Impirmir Própria Folha de Pagamento</li>
                            </a>
                            <a href="criar_folha.php" class="text-black link-underline link-underline-opacity-0">
                                <li>Criar Folha de Pagamento</li>
                            </a>
                        </ul>
                    </div>
                </div>
                <div class="option">
                    <label for="suporte">Gerenciar contas</label>
                    <div class="submenu border border-3 rounded p-4 shadow">
                        <h2>Gerenciar contas</h2>
                        <ul>
                            <a href="cadastro_admin.php" class="text-black link-underline link-underline-opacity-0">
                                <li>Criar login Administrador</li>
                            </a>
                ...
                <div class="option">
                    <label for="inventario">Gerenciar Horário de Professor</label>
                    <div class="submenu border border-3 rounded p-4 shadow">
